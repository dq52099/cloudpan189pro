...
type Handler interface {
	...
	BatchAdd() httpcontext.HandlerFunc
...
var (
	...
	busCodeStorageCloudTokenNotExist       = bi.Next("cloudToken 不存在").WithHTTPCode(http.StatusNotFound)
	...
	busCodeStorageMountPointNotFound       = bi.Next("挂载节不存在").WithHTTPCode(http.StatusNotFound)
