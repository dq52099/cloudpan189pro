...
var (
	...
	busCodeStorageCloudTokenNotExist       = bi.Next("云盘令牌不存在").WithHTTPCode(http.StatusNotFound)
	...
	busCodeStorageMountPointNotFound       = bi.Next("挂载点不存在").WithHTTPCode(http.StatusNotFound)
