...
type AutoIngestPlan struct {
	...
	AutoIngestInterval int64                 `gorm:"column:auto_ingest_interval;type:bigint;default:30" json:"autoIngestInterval"` // 单位分钟
	SourceType         autoingest.SourceType `gorm:"column:source_type;not null;type:varchar(64)" json:"sourceType"`
	Offset             int64                 `gorm:"column:offset;type:bigint;default:0;" json:"offset"`                                // 偏移量
	...
	AddCount           int64                 `gorm:"column:add_count;type:bigint;default:0;" json:"addCount"`                           // 新增挂载数
	FailedCount        int64                 `gorm:"column:failed_count;type:bigint;default:0;" json:"failedCount"`                     // 失败挂载数
...
type AutoIngestLog struct {
	ID        int64               `gorm:"primaryKey" json:"id"`
	PlanId    int64               `gorm:"column:plan_id;type:bigint;not null;default:0;" json:"planId"`
