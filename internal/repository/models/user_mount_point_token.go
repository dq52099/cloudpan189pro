...
type UserMountPointToken struct {
	...
	UserID       int64     `gorm:"column:user_id;type:bigint;not null;index;uniqueIndex:idx_user_mount_point_token_user_mount,priority:1" json:"userId"`
	MountPointID int64     `gorm:"column:mount_point_id;type:bigint;not null;index;uniqueIndex:idx_user_mount_point_token_user_mount,priority:2" json:"mountPointId"`
